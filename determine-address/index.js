    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, client.query("select 'hello postgres!' as hello;")];
                case 2:
                    q = _a.sent();
...
tryConnect().then(function () { return console.log('success!'); }).catch(function (err) { return console.log(err); });
